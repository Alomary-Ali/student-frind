...
<nav class="navbar" dir="rtl">
    <div class="navbar-inner">
        ...
        <?php if($variant === 'home' && count($navLinks) > 0): ?>
        <div class="navbar-links">
            <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($link['href'] ?? '#'); ?>"
                   class="navbar-link<?php echo e(isset($link['active']) && $link['active'] ? ' navbar-link-active' : ''); ?>">
            ...
            <?php if($user && ($user->role === 'Admin' || $user->role === 'SuperAdmin')): ?>
        ...
        <div class="hidden lg:flex items-center gap-2 flex-1 px-4 border-r border-border mr-3 pr-4">
            ...
            <a href="<?php echo e(route('home')); ?>" class="text-[11px] hover:underline text-text-muted transition-colors duration-150">الرئيسية</a>
            ...
            <span class="text-[11px] font-bold text-text-primary"><?php echo $__env->yieldContent('title', 'لوحة القيادة'); ?></span>
        </div>
        <?php endif; ?>
        ...
        <div class="navbar-actions">
            ...
            <button onclick="<?php echo e($variant === 'dashboard' ? 'openSidebar()' : 'toggleSlideMenu()'); ?>" class="navbar-mobile-toggle" aria-label="القائمة">
            ...
            <div class="navbar-user" onclick="toggleUserDropdown(event)">
                <div class="navbar-avatar"><?php echo e($initials); ?></div>
                ...
                <div id="userDropdown" class="navbar-dropdown">
                    <div class="navbar-dropdown-header">
                        <p class="navbar-dropdown-name"><?php echo e($fullName); ?></p>
                        <p class="navbar-dropdown-email"><?php echo e($email); ?></p>
                    </div>
                    <div class="navbar-dropdown-body">
                        <a href="<?php echo e(route('academic.profile')); ?>" class="navbar-dropdown-link">الملف الشخصي</a>
    ...
    <aside id="slidemenu" class="slidemenu">
        <div class="slidemenu-header">
            <div class="slidemenu-avatar"><?php echo e($initials); ?></div>
            <div class="slidemenu-user-info">
                <p class="slidemenu-user-name"><?php echo e($fullName); ?></p>
                <p class="slidemenu-user-email"><?php echo e($email); ?></p>
            </div>
        ...
        <?php if(count($navLinks) > 0): ?>
        <div class="slidemenu-body">
            <p class="slidemenu-section">الرئيسية</p>
            <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($link['href'] ?? '#'); ?>"
                   class="slidemenu-link<?php echo e(isset($link['active']) && $link['active'] ? ' slidemenu-link-active' : ''); ?>">
                    <?php if(isset($link['icon'])): ?>
                        <?php echo $link['icon']; ?>
...
<?php /**PATH E:\New folder\رفيق الطالب\resources\views/components/navbar.blade.php ENDPATH**/ ?>
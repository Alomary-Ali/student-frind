        ...
        <div class="unit-card">
            ...
            <div class="flex items-start gap-3 mb-4">
                ...
                <div class="flex-1 min-w-0">
                    <h3 class="text-sm font-black leading-tight" style="color:hsl(var(--color-text-primary));">{{ $course->title }}</h3>
                    <p class="text-[11px] mt-0.5" style="color:hsl(var(--color-text-muted));">{{ $course->creditHours }} ساعة معتمدة</p>
                </div>
            </div>

            {{-- Description --}}
            <p class="text-[12.5px] leading-relaxed mb-4 line-clamp-2" style="color:hsl(var(--color-text-secondary));">{{ $course->description }}</p>

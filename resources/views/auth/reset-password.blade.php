...
@section('description', 'إعادة تعيين كلمة المرور لمنصة رفيق الطالب')
...
<div class="flex flex-col items-center gap-3 mb-7">
    ...
    <div class="text-center">
        <h1 class="text-2xl font-black text-text-primary tracking-tight">إعادة تعيين كلمة المرور</h1>
        <p class="text-[13px] text-text-secondary mt-1 font-medium">أدخل كلمة المرور الجديدة</p>
    </div>
</div>

<form method="POST" action="{{ route('password.update') }}" class="space-y-5 animate-fade-in-up">
    @csrf
    ...
    <div class="space-y-2">
        ...
        <input type="email" id="email" name="email" required
               ...
               class="rafiq-input px-4 opacity-60">
    </div>

    <div class="space-y-2">
        <label for="password" class="text-[11px] font-bold text-text-secondary tracking-wider block px-1">كلمة المرور الجديدة</label>

...
Provides foundational cross-cutting concerns: user identity, authentication, authorization, notifications, file storage, audit logging, and system settings. Contains NO business domain logic.
...
UserRepositoryInterface, NotificationDispatcherInterface, FileStorageInterface, AuditLoggerInterface

---

## Dependencies

None (foundation module — no dependencies on other modules)

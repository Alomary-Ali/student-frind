...
Provides university administrators and advisors with data-driven insights, KPI dashboards, and cohort analysis.
...
None (read-only via event-sourced projections)

---

## Dependencies

All modules (via Domain Events)
